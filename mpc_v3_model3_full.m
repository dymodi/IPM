...
function [delta_u,delta_u_M_out,u_k,y_k,x_k,delta_u_ini,y_ini,lambda_ini] = mpc_v3_model3(delta_u,delta_u_M_in,u_k,y_k,x_k,r_k,delta_u_ini,y_ini,lambda_ini)
...
%[delta_u_M_out,~,~,Iter] = IPM_v2_full(G,GL,c,-OMEGA_L,-omega_r,delta_u_ini,y_ini,lambda_ini);
